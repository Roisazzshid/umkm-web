...
<head>
    ...
    <title>{{ $title ?? 'Dashboard UMKM | Rintasa' }}</title>
...
<body class="bg-white text-ink font-sans min-h-screen">
    <div class="md:grid md:grid-cols-[220px_1fr] min-h-screen">
        <div
            ...
            <div class="flex items-center gap-2">
                ...
                <span class="font-bold text-sm text-ink">Toko saya</span>
            </div>
        ...
        <aside id="sidebar"
            ...
            <x-sidebar-item icon="ti-layout-dashboard" label="Dashboard" href="{{ route('umkm.dashboard') }}"
                :active="request()->routeIs('umkm.dashboard')" />
            <x-sidebar-item icon="ti-building-store" label="Profil toko" href="{{ route('umkm.profil') }}"
                :active="request()->routeIs('umkm.profil')" />
            <x-sidebar-item icon="ti-package" label="Kelola produk" href="{{ route('umkm.produk.index') }}"
                :active="request()->routeIs('umkm.produk.*')" />
            <x-sidebar-item icon="ti-star" label="Ulasan dan rating" href="{{ route('umkm.ulasan') }}"
                :active="request()->routeIs('umkm.ulasan')" />
            <x-sidebar-item icon="ti-chart-bar" label="Laporan" href="{{ route('umkm.laporan') }}" :active="request()->routeIs('umkm.laporan')" />
    ...
    <div id="modal-logout" class="hidden fixed inset-0 bg-ink/50 flex items-center justify-center px-5 z-50">
        <div class="bg-white rounded-2xl p-6 sm:p-8 max-w-sm w-full text-center">
            ...
            <h2 class="font-bold text-ink text-base sm:text-lg mb-1.5">Keluar dari akun toko?</h2>
